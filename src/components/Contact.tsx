...
function Contact(): ReactElement {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <form action="/" className="flex flex-col gap-2 border-gray-400 border-4 px-8 py-6 rounded-xl bg-white h-2/5 ">
        ...
        <input type="text" placeholder="Why is this website so good?" id="query" className="border-2 p-2 rounded-xl md:h-12 md:mb-2"/>
        <button className="border-2 p-2 rounded-xl w-40">Send your query</button>
      </form>
    </div>
  )
}
